...
**具体写作格式与规范在页面**：
- [写作者模板 - 1. 基础](writing-template-basic.md)  （基础语法），与
- [写作者模板 - 2. 代码](writing-template-code.md) （交互代码块）中；

**写作的内容呈现在页面**：
- [MOF书籍示例第一章（基础）](ch1-mof-basics.md) ，与
- [MOF书籍示例第二章（进阶）](ch2-mof-advanced.md) 为参考。
